...
Functions within the `interactionRCS` package require that a regression model has already been estimated and model results be provided as an object. Because of their flexibility in dealing with restricted cubic splines, `interactionRCS` requires the Cox model to be fitted with the `cph` function of  `rms` package. 
