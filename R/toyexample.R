...
par(mfrow=c(1,2))
plot(myHR , xlab = "ph.karno" , main = "Delta" , log=TRUE)
plot(myHR2 , xlab = "ph.karno" , main = "Bootstrap" , log=TRUE)
#-------------------#
# Interaction Model #
#-------------------#
...
# Try plot
par(mfrow=c(1,2))
plot.HR(myHR , xlab = "Age" , main = "delta")
plot.HR(myHR2 , xlab = "Age" , main = "bootstrap")
